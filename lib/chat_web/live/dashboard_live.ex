defmodule ChatWeb.DashboardLive do
  ...
  alias Chat.{Auth, Messenger}
  alias Chat.Messenger.Conversation
  alias ChatWeb.DashboardView
  alias Chat.Repo
  ...
  def mount(_params, %{"current_user" => current_user}, socket) do
    ChatWeb.Endpoint.subscribe("user_conversations_#{current_user.id}")
  ...
  def handle_event(
        ...
        %{assigns: %{conversation_changeset: changeset, contacts: contacts}} = socket
      ) do
    title =
